"""Extracts weather data from metar (meteriological aerodrome report) files and calculates wind direction
Steps are sequential and each step requires input of the previous step
Steps:
    - read metar files
    - parse
